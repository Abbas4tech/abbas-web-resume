...
export const generateMetadata = async (): Promise<Metadata> => {
  try {
    ...
    console.error("Error generating metadata for /skills:", error);
    return {
      title: "Skills | Abbas Shaikh",
      description: "Skills of Abbas Shaikh",
    };
  }
};
...
const Page = async (): Promise<React.JSX.Element> => {
  try {
    ...
    console.error("❌ Error in /skills page:", errorMessage);
    return (
