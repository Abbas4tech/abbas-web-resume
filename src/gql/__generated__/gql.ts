...
const documents: Documents = {
    ...
    "query fetchAllPagePaths {\n  pageCollection(limit: 100) {\n    items {\n      path\n    }\n  }\n}": types.FetchAllPagePathsDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment BioCard on BioCard {\n  title\n  value\n  __typename\n  _id\n  icon {\n    ...Icon\n  }\n}"): (typeof documents)["fragment BioCard on BioCard {\n  title\n  value\n  __typename\n  _id\n  icon {\n    ...Icon\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment ExperiencePageData on ExperiencePageData {\n  title\n  _id\n  __typename\n  experiencesCollection(limit: 10) {\n    items {\n      ...JobExperience\n    }\n  }\n}"): (typeof documents)["fragment ExperiencePageData on ExperiencePageData {\n  title\n  _id\n  __typename\n  experiencesCollection(limit: 10) {\n    items {\n      ...JobExperience\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment HomePageData on HomePageData {\n  _id\n  description {\n    json\n  }\n  title\n  __typename\n  infoCollection {\n    items {\n      title\n      __typename\n      value\n      icon {\n        ...Icon\n      }\n    }\n  }\n}"): (typeof documents)["fragment HomePageData on HomePageData {\n  _id\n  description {\n    json\n  }\n  title\n  __typename\n  infoCollection {\n    items {\n      title\n      __typename\n      value\n      icon {\n        ...Icon\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment Icon on Icon {\n  _id\n  classes\n  __typename\n  name\n  iconCode\n  showTooltip\n}"): (typeof documents)["fragment Icon on Icon {\n  _id\n  classes\n  __typename\n  name\n  iconCode\n  showTooltip\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment JobExperience on JobExperience {\n  company\n  companyIcon {\n    ...Icon\n  }\n  currentlyWorking\n  __typename\n  workedRemotely\n  techStackIcon {\n    ...Icon\n  }\n  description {\n    json\n  }\n  durationIcon {\n    ...Icon\n  }\n  endDate\n  position\n  startDate\n  location\n  locationIcon {\n    ...Icon\n  }\n  roleIcon {\n    ...Icon\n  }\n  techStack {\n    skillProgress\n    _id\n    title\n    skillIconsCollection {\n      items {\n        ...Icon\n      }\n    }\n  }\n}"): (typeof documents)["fragment JobExperience on JobExperience {\n  company\n  companyIcon {\n    ...Icon\n  }\n  currentlyWorking\n  __typename\n  workedRemotely\n  techStackIcon {\n    ...Icon\n  }\n  description {\n    json\n  }\n  durationIcon {\n    ...Icon\n  }\n  endDate\n  position\n  startDate\n  location\n  locationIcon {\n    ...Icon\n  }\n  roleIcon {\n    ...Icon\n  }\n  techStack {\n    skillProgress\n    _id\n    title\n    skillIconsCollection {\n      items {\n        ...Icon\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment ProjectsPageData on ProjectsPageData {\n  _id\n  title\n  __typename\n  projectsCollection {\n    items {\n      _id\n      deployedLink\n      title\n      __typename\n      description\n      deployedLinkIcon {\n        ...Icon\n      }\n      thumbnail {\n        ...Asset\n      }\n    }\n  }\n}"): (typeof documents)["fragment ProjectsPageData on ProjectsPageData {\n  _id\n  title\n  __typename\n  projectsCollection {\n    items {\n      _id\n      deployedLink\n      title\n      __typename\n      description\n      deployedLinkIcon {\n        ...Icon\n      }\n      thumbnail {\n        ...Asset\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment SkillsPageData on SkillsPageData {\n  _id\n  title\n  __typename\n  skillsSetCollection(limit: 10) {\n    items {\n      title\n      icon {\n        ...Icon\n      }\n      skillsArrayCollection(limit: 10) {\n        items {\n          _id\n          title\n          skillIconsCollection(limit: 10) {\n            __typename\n            items {\n              ...Icon\n            }\n          }\n          skillProgress\n          __typename\n        }\n      }\n    }\n  }\n}"): (typeof documents)["fragment SkillsPageData on SkillsPageData {\n  _id\n  title\n  __typename\n  skillsSetCollection(limit: 10) {\n    items {\n      title\n      icon {\n        ...Icon\n      }\n      skillsArrayCollection(limit: 10) {\n        items {\n          _id\n          title\n          skillIconsCollection(limit: 10) {\n            __typename\n            items {\n              ...Icon\n            }\n          }\n          skillProgress\n          __typename\n        }\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment SeoData on SeoData {\n  countryName\n  creator\n  description\n  keywords\n  __typename\n  url\n  siteName\n  publisher\n  imagesCollection {\n    items {\n      ...Asset\n    }\n  }\n  favicon {\n    ...Asset\n  }\n  title\n  sys {\n    id\n  }\n}"): (typeof documents)["fragment SeoData on SeoData {\n  countryName\n  creator\n  description\n  keywords\n  __typename\n  url\n  siteName\n  publisher\n  imagesCollection {\n    items {\n      ...Asset\n    }\n  }\n  favicon {\n    ...Asset\n  }\n  title\n  sys {\n    id\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query fetchAllPagePaths {\n  pageCollection(limit: 100) {\n    items {\n      path\n    }\n  }\n}"): (typeof documents)["query fetchAllPagePaths {\n  pageCollection(limit: 100) {\n    items {\n      path\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query fetchPageByPath($path: String!) {\n  pageCollection(where: {path: $path}, limit: 1) {\n    items {\n      _id\n      path\n      title\n      contentAnimation\n      pageSeo {\n        ...SeoData\n      }\n      pageData {\n        __typename\n        ... on HomePageData {\n          ...HomePageData\n        }\n        ... on ExperiencePageData {\n          ...ExperiencePageData\n        }\n        ... on SkillsPageData {\n          ...SkillsPageData\n        }\n        ... on ProjectsPageData {\n          ...ProjectsPageData\n        }\n      }\n      headingAnimation\n      pageIcon {\n        ...Icon\n      }\n    }\n  }\n}"): (typeof documents)["query fetchPageByPath($path: String!) {\n  pageCollection(where: {path: $path}, limit: 1) {\n    items {\n      _id\n      path\n      title\n      contentAnimation\n      pageSeo {\n        ...SeoData\n      }\n      pageData {\n        __typename\n        ... on HomePageData {\n          ...HomePageData\n        }\n        ... on ExperiencePageData {\n          ...ExperiencePageData\n        }\n        ... on SkillsPageData {\n          ...SkillsPageData\n        }\n        ... on ProjectsPageData {\n          ...ProjectsPageData\n        }\n      }\n      headingAnimation\n      pageIcon {\n        ...Icon\n      }\n    }\n  }\n}"];
