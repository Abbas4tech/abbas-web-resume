...
import { adaptCardGallery } from "./card-gallery.adapter";

describe("adaptCardGallery", () => {
  it("adapts generic ContentList to CardGalleryProps", () => {
    ...
    const result = adaptCardGallery(input);
