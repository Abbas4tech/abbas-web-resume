...
import { adaptBioSection } from "./bio-section.adapter";

describe("adaptBioSection", () => {
  it("adapts generic ContentSection to BioSectionProps", () => {
    ...
    const result = adaptBioSection(input);
