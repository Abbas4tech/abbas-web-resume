...
const RichText: FC<RichTextProps> = ({
  ...
  const options: Options = {
    ...
    renderNode: {
      ...
      [BLOCKS.HEADING_3]: (_node, children) => <h3 className={getHeadingClass(3)}>{children}</h3>,
      [BLOCKS.HEADING_4]: (_node, children) => <h4 className={getHeadingClass(4)}>{children}</h4>,
      [BLOCKS.HEADING_5]: (_node, children) => <h5 className={getHeadingClass(5)}>{children}</h5>,
      [BLOCKS.HEADING_6]: (_node, children) => <h6 className={getHeadingClass(6)}>{children}</h6>,
      ...
      [BLOCKS.LIST_ITEM]: (_node, children) => <li className={listItemClass}>{children}</li>,
      ...
      [BLOCKS.TABLE_ROW]: (_node, children) => <tr className={tableRowClass}>{children}</tr>,
      [BLOCKS.TABLE_CELL]: (_node, children) => <td className={tableCellClass}>{children}</td>,
    },
  };
